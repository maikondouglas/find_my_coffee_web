...
      {
        (establishment.photos) ?
          <Image src={`https://maps.googleapis.com/maps/api/place/photo?photoreference=${establishment.photos[0].photo_reference}&key=${REACT_APP_GOOGLE_KEY}&maxwidth=400`}
            alt="Coffee Photo"
          />
      ...
      <Title>{establishment.name}</Title>
      {
        ...
        : <Paragraph>Não há cadatro de dias e horários aberto</Paragraph>
      }
      <hr />
