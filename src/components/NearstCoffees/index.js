...
const NearstCoffees = (props) => {
  ...
  return(
    <RightBar>
      ...
      <Body>
        <strong>Mais amadas na região</strong>
        <hr />
        {
          stores.map(store => {
            return(
              <EstablishmentItem key={store.name}>
                ...
                <ReactStars edit={false} value={store.ranting_averange || 0 } />
                <hr />
              </EstablishmentItem>
            )
          })
      ...
      <Footer>
        ...
        <Paragraph>
          Projeto Open Source desenvolvido  na semana Super Full Stack
          da escola online de programação
        </Paragraph>
      </Footer>
    </RightBar>
  )
